...
import com.android.gsixacademy.kotlinbasictutorial.CarsAdapter
import com.android.gsixacademy.kotlinbasictutorial.CarsAdapterClickEvent
...
class MoviesAdapter(
    ...
    inner class MyViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        fun bindData(itemModel: MovieResult, position: Int) {
            ...
            Picasso.get().load("https://image.tmdb.org/t/p/w500/${itemModel.poster_path}").fit().centerInside().into(itemView.image_view_movie)
